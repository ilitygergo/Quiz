...
INSERT into Usr values(NULL, 'admin', 'Admin', 'Admin', 'admin123@gmail.com', 'password123', TO_TIMESTAMP('1998-03-15', 'YYYY-MM-DD'), 'male', 1);
INSERT into Usr values(NULL, 'test', 'Teszt', 'Elek', 'tesztelek@gmail.com', 'password123', TO_TIMESTAMP('1998-03-15', 'YYYY-MM-DD'), 'male', 0);
INSERT into Usr values(NULL, 'test2', 'Teszt', 'Balázs', 'teszbalazs@gmail.com', 'password123', TO_TIMESTAMP('1994-06-10', 'YYYY-MM-DD'), 'male', 0);

INSERT into Results values(NULL, 5, 0, TO_TIMESTAMP('2019-02-20', 'YYYY-MM-DD'), 'History', 2);
INSERT into Results values(NULL, 8, 0, TO_TIMESTAMP('2019-02-24', 'YYYY-MM-DD'), 'History', 3);

INSERT into Challenges values(NULL, 0, TO_TIMESTAMP('2019-02-20', 'YYYY-MM-DD'), 'History', 2, 3);
...
INSERT into Friends values(2, 3, TO_TIMESTAMP('2019-02-19', 'YYYY-MM-DD'), 'active');
