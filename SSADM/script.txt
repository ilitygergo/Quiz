...
create table Results(
  resultsID NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  score NUMBER(10),
  hard NUMBER(1),
  time	DATE,
  topic VARCHAR(30),
...
ALTER TABLE Results
  ADD (
    CONSTRAINT Results_pk PRIMARY KEY (resultsID)
  );
  
create table Challanges(
 challangeID NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
 hard NUMBER(1),
 time	DATE,
 topic VARCHAR(30),
...
ALTER TABLE Challanges
  ADD (
    CONSTRAINT Challange_pk PRIMARY KEY (challangeID)
  );
  
create table Questions(
  questionID NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  hard NUMBER(1),
  topic	VARCHAR(30),
  correct	VARCHAR(50),
  wrong1	VARCHAR(50),
